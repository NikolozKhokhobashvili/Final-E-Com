...
const Hero = () => {
    return (
        <div className="bg-[#F6F6F6] w-[100%] h-[440px] absolute top-[126px] overflow-hidden ">
            <h2 className="font-inter font-[600] text-[32px] leading-[38.73px] tracking-[-3.5%] text-[#202533] w-[313px] h-[39px] absolute top-[136px] left-[182px]">Fresh Arrivals Online</h2>
            ...
            <div className="flex items-center w-[183px] h-[44px] absolute  top-[260px] left-[182px] rounded-[4px] py-[12px] px-[24px] bg-[#0E1422] gap-[6px]">
